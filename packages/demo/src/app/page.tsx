                ...
                <section className="py-24 sm:py-32 bg-gradient-to-b from-gray-50 to-white mx-3 sm:mx-8 rounded-[2.5rem] overflow-hidden">
                    <div className="max-w-7xl mx-auto px-6 sm:px-12">
                            ...
                            {[
                                {
                                    ...
                                    url: 'https://heroku.com/deploy?template=https://github.com/AlleyBo55/x402-facilitator-oss',
                                    icon: (
                                ...
                                },
                                {
                                    ...
                                    url: 'https://railway.app/template?template=https://github.com/AlleyBo55/x402-facilitator-oss',
                                    icon: (
                                        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                                ...
                                },
                                {
                                    ...
                                    url: 'https://render.com/deploy?repo=https://github.com/AlleyBo55/x402-facilitator-oss',
                                    icon: (
                                        <svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
                        ...
                        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 text-sm">
                            <a
                                href="https://github.com/AlleyBo55/x402-facilitator-oss"
                                target="_blank"
